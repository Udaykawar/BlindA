...
import com.example.blinda.Commands;
import com.example.blinda.IsSpeaking;
import com.example.blinda.R;
...
public class display_frag extends DialogFragment implements TextToSpeech.OnInitListener {
    ...
    public void show(FragmentManager fragmentManager, String sss) {
    }
}
